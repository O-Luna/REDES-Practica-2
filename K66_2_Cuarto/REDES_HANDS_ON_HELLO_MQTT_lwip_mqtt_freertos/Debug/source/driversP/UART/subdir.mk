...
C_DEPS += \
./source/driversP/UART/uart_d.d 

OBJS += \
./source/driversP/UART/uart_d.o 


# Each subdirectory must supply rules for building sources it contributes
source/driversP/UART/%.o: ../source/driversP/UART/%.c source/driversP/UART/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-source-2f-driversP-2f-UART

clean-source-2f-driversP-2f-UART:
	-$(RM) ./source/driversP/UART/uart_d.d ./source/driversP/UART/uart_d.o

.PHONY: clean-source-2f-driversP-2f-UART
