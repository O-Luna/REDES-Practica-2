...
C_DEPS += \
./source/driversP/GPIO/GPIO.d 

OBJS += \
./source/driversP/GPIO/GPIO.o 


# Each subdirectory must supply rules for building sources it contributes
source/driversP/GPIO/%.o: ../source/driversP/GPIO/%.c source/driversP/GPIO/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-source-2f-driversP-2f-GPIO

clean-source-2f-driversP-2f-GPIO:
	-$(RM) ./source/driversP/GPIO/GPIO.d ./source/driversP/GPIO/GPIO.o

.PHONY: clean-source-2f-driversP-2f-GPIO
